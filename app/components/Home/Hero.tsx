    ...
    <div className="pt-[5rem] pb-[3rem]">
      <div className="w-[100%] h-[60vh] flex flex-col items-center justify-center">
        <div className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-[2rem]">
          {/* content */}
          <div>
            <h1 className="text-[28px] sm:text-[35px] lg:text-[45px] xl:text-[50px] text-[#05264e] leading-[3rem] lg:leading-[4rem] font-extrabold">
            ...
            <div className="mt-[1.5rem]">
              <input
                className="w-[60%] md:w-[70%] lg:w-[75%] px-4 py-3 outline-none rounded-l-md bg-gray-200"
                type="text"
                placeholder="Search Job."
              />
              <button className="px-4 py-3 outline-none rounded-r-md bg-blue-500 text-white">Search</button>
            </div>
          </div>
          {/* image */}
