...
const JobCategoryCard = ({ image, category, openPosition }: Props) => {
  return <div className="p-4 border-2 cursor-pointer hover:scale-110 hover:shadow-sm transition-all duration-300 border-gray-500 rounded-lg border-opacity-10">
